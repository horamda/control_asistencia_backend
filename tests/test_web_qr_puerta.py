...
def test_qr_puerta_post_ok(monkeypatch):
    ...
    monkeypatch.setattr(qr_routes, "generar_token_qr", lambda payload, vigencia_segundos=120: "qr-token-demo")
    ...
    resp = client.post(
        "/qr-puerta/",
        data={"empresa_id": "1", "sucursal_id": "10", "tolerancia_m": "80", "vigencia_dias": "30"},
