-- Modulo SKAP (Skills, Knowledge, Attitude, Performance)
-- Fecha: 2026-06-07

CREATE TABLE IF NOT EXISTS skap_preguntas (
...
CREATE TABLE IF NOT EXISTS skap_evaluaciones_detalle (
    id                        INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS skap_planes_desarrollo (
    id                INT AUTO_INCREMENT PRIMARY KEY,
    evaluacion_id     INT NOT NULL,
    empresa_id        INT NOT NULL,
    empleado_id       INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS skap_planes_desarrollo_acciones (
    id                    INT AUTO_INCREMENT PRIMARY KEY,
